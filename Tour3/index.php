...
$res=round($res,2);
//var_dump($res);
$co = $connect->query("SELECT tour3,nom FROM groupe WHERE section LIKE '%$sec%'");
$c=$co->fetch();
$res+=$c['tour3'];
$_SESSION['score']=$res;
$_SESSION['nom']=$c['nom'];
//var_dump($res);
if ($res<100) {
$connect->exec("UPDATE groupe SET tour3=$res WHERE section LIKE '%$sec%'");	
}
//var_dump($res);
}
else {
...
$result = $connect->query("SELECT tour3,nom,section FROM groupe WHERE section LIKE '%$seco%'");
$ca=$result->fetch();
//var_dump($ca);
?>
	<div class="contact1">
...
<button class="contact1-form-btn">
		...
		<i class="fa fa-long-arrow-left" aria-hidden="true"></i>
			...
			<h3 class="text-success"><?=$ca['nom']?></h3>
               <div class="circliful-chart" data-dimension="190" data-text="<?php echo ''.$ca['tour3'].'%'?>" data-width="10" data-fontsize="25" data-percent="<?=$ca['tour3']?>" data-fgcolor="#5fbeaa" data-bgcolor="#ebeff2"></div>
			...
			<form class="contact1-form validate-form" action="" method="post">
				...
				$corr = $connect->query("SELECT *FROM groupe WHERE dst2 = '1'");
